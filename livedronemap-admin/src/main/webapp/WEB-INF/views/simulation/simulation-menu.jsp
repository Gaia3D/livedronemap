	...
	<li id="simulationLogMenu" class="" title="시뮬레이션">
			<div style="margin-top:15px;">
				<table>
					...
					<tr style="height:35px; font-weight: bold">
						<td style="width:150px; color:#444; font-family:'Malgun Gothic','돋움',dotum, sans-serif; font-size:13px; line-height:1.5em;"><span> 영상처리 테스트</span></td>
						<td><button type="button" class="btnText" onclick="simulateProcess('client')">테스트</button></td>
					</tr>
					
					<tr style="height:35px; font-weight: bold">
						<td style="width:150px; color:#444; font-family:'Malgun Gothic','돋움',dotum, sans-serif; font-size:13px; line-height:1.5em;"><span> 시각화 테스트 </span></td>
