...
<div id="nav">
	<ul>
		...
		<li id="schedulerMenu" style="background-image: url(../../images/clock.png);background-size: 20px;background-position-y: center;background-position-x: 10px;" title="스케줄러" onclick="goPage('/scheduler/list-health-check');"><span>스케줄러</span></li>
		<li id="deviceMenu" style="background-image: url(../../images/device.png);background-size: 17px;background-position-y: center;background-position-x: 10px;" title="장비" onclick="goPage('/client/input-client');"><span>장비</span></li>
